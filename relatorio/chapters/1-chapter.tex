...
Finalmente, o \cref{chapter:tcc2} tratará do planejamento das atividades para a segunda parte deste trabalho. Essa etapa consistirá da implementação dos algoritmos apresentados e da realização de experimentos utilizando o QMDD. O objetivo dos experiementos é garantir que a implementação produz resultados corretos, além de permitir a análise de desempenho desse método para simulação de circuitos quânticos. 
