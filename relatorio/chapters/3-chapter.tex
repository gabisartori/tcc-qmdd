...
% TODO: The values are kinda cramped, I need to space the edges a bit more
...
\begin{equation}
  ...
  \begin{tikzpicture}[
    ...
    \draw[->, draw=red] (v) edge[bend right=90]  node[right]  {0} (t);
    \draw[->, draw=blue] (v) edge[bend right=30]  node[right]  {1} (t);
    \draw[->, draw=green] (v) edge[bend left=30] node[right] {1} (t);
    \draw[->, draw=orange] (v) edge[bend left=90] node[right] {0} (t);
  ...
  \begin{tikzpicture}[
    ...
    \draw[->, draw=red] (v) edge[bend right=90]  node[right]  {0} (t); % (0,0)
    \draw[->, draw=blue] (v) edge[bend right=30]  node[right]  {0} (t); % (0,1)
    \draw[->, draw=green] (v) edge[bend left=30] node[right] {$\frac{1}{\sqrt{2}}$} (t); % (1,0)
    \draw[->, draw=orange] (v) edge[bend left=90] node[right] {$\frac{1}{\sqrt{2}}$} (t); % (1,1)
  ...
  \begin{tikzpicture}[
    ...
    \draw[->, draw=red] (v) edge[bend right=90]  node[right]  {$\frac{1}{\sqrt{2}}$} (t); % (0,0)
    \draw[->, draw=blue] (v) edge[bend right=30]  node[right]  {$\frac{-1}{\sqrt{2}}$} (t); % (0,1)
    \draw[->, draw=green] (v) edge[bend left=30] node[right] {0} (t); % (1,0)
    \draw[->, draw=orange] (v) edge[bend left=90] node[right] {0} (t); % (1,1)
  ...
  \begin{tikzpicture}[
    ...
    \draw[->, draw=red] (v) edge[bend right=90]  node[right]  {1} (t); % (0,0)
    \draw[->, draw=blue] (v) edge[bend right=30]  node[right]  {-1} (t); % (0,1)
    \draw[->, draw=green] (v) edge[bend left=30] node[right] {1} (t); % (1,0)
    \draw[->, draw=orange] (v) edge[bend left=90] node[right] {1} (t); % (1,1)
