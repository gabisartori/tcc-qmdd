...
\begin{equation}
  ...
  \begin{tikzpicture}[
    ...
    \draw[->, draw=green] (v) edge[bend left=15] node[right] {$\frac{1}{\sqrt{2}}$} (t); % (1,0)
  ...
  \begin{tikzpicture}[
    ...
    \draw[->, draw=blue] (v) edge[bend right=20]  node[right]  {$\frac{-1}{\sqrt{2}}$} (t); % (0,1)
    \draw[->, draw=green] (v) edge[bend left=40] node[right] {0} (t); % (1,0)
