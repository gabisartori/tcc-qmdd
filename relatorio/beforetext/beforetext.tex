...
\begin{resumo}[Abstract]
  \begin{otherlanguage*}{english}
    ...
    Similarly, classic simulation also has challenges: memory usage grows exponentially in relation to the number of qubits in the circuit to be simulated, rendering it infeasible for larger circuits. This project's goal is to implement a new simulation technique and integrate it to Ket. This new method utilizes QMDDs (Quantum Multiple-valued Decision Diagrams), a data structure capable of representing and executing quantum circuits by using matrices, exploiting the redundancy present in them in order to encode them in a way that reduces the memory usage.
